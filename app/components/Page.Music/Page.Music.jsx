      ...
      <section id="Music" className="row page-music">
        <div className="col">
          ...
          <iframe
            ...
            scrolling="no"
            frameborder="no"
            src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/238466798&amp;color=cb9326&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false">
          </iframe>
        </div>
      </section>
    );
